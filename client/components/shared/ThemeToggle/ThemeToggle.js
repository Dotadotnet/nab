...
import functionLogoChanger from "../logo/FunctionLogoChanger";
export default function ThemeToggle() {
  ...
  const changeCurrentTheme = (newTheme) => {
    ...
    axios.post(process.env.NEXT_PUBLIC_BASE_URL + "/cookie/set/theme/" + newTheme)
    functionLogoChanger()
  };
  ...
  return (
    <div className="flex justify-center">
      ...
      />
      <label
        className="p-2 cursor-pointer rounded-secondary  dark:bg-slate-900 bg-slate-100  hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors"
