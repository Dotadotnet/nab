...
const Banner2 = ({}) => {
  ...
  return (
    <Container >
      <div
        className="bg-yellow-100  dark:bg-red-500 h-full pt-8 w-full dark:text-gray-100 rounded-primary gap-16 flex md:flex-row flex-col gap-y-0  px-8  "
        style={{ backgroundImage: "url(/assets/home/banner/dots.svg)" }}
      >
        <div className="w-fit h-fit order-2 md:order-1">
          <Image
