        ...
        >
          ...
          <SwiperSlide>
            <div className="flex flex-col gap-y-4 p-4">
              ...
              <div className={ dir == "ltr" ? "absolute flex -bottom-8  md:flex -left-44" : "absolute flex -bottom-8  md:flex -right-40"}>
                <motion.div
                  animate={{ y: ["0px", "20px", "0px"] }}
                  transition={{
                    repeat: Infinity,
            ...
            <div className={ dir == "ltr" ? "absolute flex -bottom-8   -right-28" : "absolute flex -bottom-16  -left-36"}>
              <motion.div
                animate={{ y: ["0px", "20px", "0px"] }}
                transition={{
                  repeat: Infinity,
          ...
          <SwiperSlide>
            ...
            <div className={ dir == "ltr" ? "absolute flex -bottom-8   -right-32" : "absolute flex -bottom-8  -left-32 "}>
              <motion.div
                animate={{ y: ["0px", "20px", "0px"] }}
                transition={{
                  repeat: Infinity,
