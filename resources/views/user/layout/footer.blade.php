<footer class=" w-full flex flex-col sm:flex-row flex-wrap justify-center sm:justify-around p-3 sm:p-5">
    <div class="text footer-group shadow-primary-200 w-full md:w-auto   ">
        <div class="flex  flex-col m-3">
            <span class="mr-4 text-md sm:text-lg"> <i class="fa fa-phone" aria-hidden="true"></i>
                تماس با ما :</span>
            <a href="tel:+989999935106" class="md:mr-24 mr-10 text-md mt-3 hover:pr-5 hover:font-bold ">09999935106</a>
            <a href="tel:+989917240849" class="md:mr-24 mr-10 text-md mt-3 hover:pr-5 hover:font-bold ">09917240849</a>
    ...
    <div class="text shadow-primary-200 flex w-full sm:w-auto flex-col   ">
        <span class="w-full flex justify-center">
            <img class="h-32 w-40 logo " src="{{ asset('image/Logo light.png') }}">
        </span>
