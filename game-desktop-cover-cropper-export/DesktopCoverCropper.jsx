  ...
  const handleCrop = async () => {
    ...
    canvas.toBlob(
      (blob) => {
        ...
        const croppedFile = new File([blob], `desktop-1920x1080-${name}.webp`, {
          type: "image/webp",
        });
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/85 p-4 backdrop-blur" dir="rtl">
      <div className="w-full max-w-5xl overflow-hidden border border-zinc-800 bg-zinc-950">
        <div className="flex items-center justify-between border-b border-zinc-800 px-4 py-3">
          <div>
            <p className="text-xs text-zinc-500">Desktop detail image</p>
            <h2 className="text-base font-bold text-white">Crop image</h2>
          </div>
          <button
        ...
        <div className="grid gap-4 p-4 lg:grid-cols-[minmax(0,1fr)_220px]">
          ...
          <div className="flex flex-col justify-between gap-4">
            <div className="space-y-3 text-sm leading-7 text-zinc-400">
              <p>The selection frame always uses the full image width and keeps a 1920 by 540 ratio.</p>
              <p>Move the frame vertically. The final output is generated at 1920 by 1080.</p>
            </div>
