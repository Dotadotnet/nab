...
const MagazineHeader = ({ isLoading, avatar, author, publishDate }) => (
...
const MagazineMedia = ({ isLoading, galleryPreview }) => {
...
const MagazineContentComponent = ({ content, isLoading, title, selectedTags }) => (
  <>
...
const MagazineComments = ({ comments }) => (
...
// Main MagazineContent component that combines all parts
const MagazineContent = ({ 
  ...
  // Use the comment prop if comments is not provided
  const commentsToUse = comments || comment || [];
  ...
  return (
    <div className="w-full">
      ...
      />
      <MagazineComments comments={commentsToUse} />
    </div>
  );
};
