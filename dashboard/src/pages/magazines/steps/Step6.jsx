...
const Step6 = ({ register, errors, control, getValues }) => {
  const {
  ...
  return (
    <>
      ...
      >
        <span className="text-sm">درج شبکه اجتماعی</span>
      ...
      <div className="flex justify-between mt-12 right-0 absolute bottom-2 w-full px-8">
        <NavigationButton direction="next" onClick={() => {}} /> {/* This will submit the form */}
